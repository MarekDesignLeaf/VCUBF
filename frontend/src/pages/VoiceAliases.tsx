...
function copyFor(language: string): Copy {
  ...
  const table: Record<string, Copy> = {
    en: {
      title: "Voice aliases",
      intro: "When {assistant} keeps mishearing a word, say it three times and the way it is actually heard becomes permanent. You can also add an alias here directly.",
      addressHeading: "How {assistant} is addressed",
      ...
      meansHintAddress: "The real wake word, for example {assistant}.",
    ...
    cs: {
      ...
      intro: "Když {assistant} nějaké slovo pořád špatně slyší, řekněte ho třikrát a to, jak ho skutečně slyší, se uloží natrvalo. Alias můžete přidat i ručně zde.",
      addressHeading: "Oslovení asistenta",
      ...
      meansHintAddress: "Skutečné oslovení, například {assistant}.",
    ...
    pl: {
      ...
      intro: "Jeśli {assistant} stale źle słyszy jakieś słowo, powiedz je trzy razy, a sposób, w jaki je faktycznie słyszy, zostanie zapisany na stałe. Alias możesz też dodać ręcznie.",
      addressHeading: "Zwracanie się do asystenta",
      ...
      meansHintAddress: "Prawdziwe słowo aktywujące, na przykład {assistant}.",
    ...
    de: {
      title: "Sprachaliase",
      intro: "Wenn {assistant} ein Wort immer wieder falsch hört, sagen Sie es dreimal — die tatsächlich gehörte Form wird dauerhaft gespeichert. Sie können einen Alias auch hier eintragen.",
      addressHeading: "Anrede von {assistant}",
      ...
      meansHintAddress: "Das echte Aktivierungswort, zum Beispiel {assistant}.",
    ...
    fr: {
      title: "Alias vocaux",
      intro: "Si {assistant} entend mal un mot de façon répétée, dites-le trois fois : la forme réellement entendue est enregistrée définitivement. Vous pouvez aussi ajouter un alias ici.",
      addressHeading: "Comment appeler {assistant}",
      ...
      meansHintAddress: "Le vrai mot d'activation, par exemple {assistant}.",
    ...
    es: {
      title: "Alias de voz",
      intro: "Si {assistant} sigue oyendo mal una palabra, dígala tres veces: la forma en que realmente se oye queda guardada de forma permanente. También puede añadir un alias aquí.",
      addressHeading: "Cómo se llama a {assistant}",
      ...
      meansHintAddress: "La palabra de activación real, por ejemplo {assistant}.",
    ...
    it: {
      title: "Alias vocali",
      intro: "Se {assistant} continua a sentire male una parola, ditela tre volte: il modo in cui viene realmente sentita viene salvato in modo permanente. Potete anche aggiungere un alias qui.",
      addressHeading: "Come ci si rivolge a {assistant}",
      ...
      meansHintAddress: "La vera parola di attivazione, per esempio {assistant}.",
