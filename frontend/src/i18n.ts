...
const ENGLISH: Record<MenuKey, string> = {
  ...
  playbooks: "Playbooks", learning: "Learning", emmaMemory: "Emma Memory", emmaPermissions: "Emma permissions", voiceAliases: "Voice aliases", logout: "Log out",
...
const TRANSLATIONS: Record<AppLanguage, Partial<Record<MenuKey, string>>> = {
  ...
  "cs-CZ": {
    ...
    playbooks: "Postupy", learning: "Učení", emmaMemory: "Paměť Emmy", emmaPermissions: "Oprávnění Emmy", voiceAliases: "Hlasové aliasy", logout: "Odhlásit se",
  ...
  "pl-PL": {
    ...
    playbooks: "Procedury", learning: "Uczenie", emmaMemory: "Pamięć Emmy", emmaPermissions: "Uprawnienia Emmy", voiceAliases: "Aliasy głosowe", logout: "Wyloguj się",
  ...
  "fr-FR": {
    ...
    playbooks: "Procédures", learning: "Apprentissage", emmaMemory: "Mémoire d’Emma", emmaPermissions: "Autorisations d’Emma", voiceAliases: "Alias vocaux", logout: "Se déconnecter",
  ...
  "de-DE": {
    ...
    playbooks: "Abläufe", learning: "Lernen", emmaMemory: "Emma-Speicher", emmaPermissions: "Emma-Berechtigungen", voiceAliases: "Sprachaliase", logout: "Abmelden",
  ...
  "es-ES": {
    ...
    playbooks: "Procedimientos", learning: "Aprendizaje", emmaMemory: "Memoria de Emma", emmaPermissions: "Permisos de Emma", voiceAliases: "Alias de voz", logout: "Cerrar sesión",
  ...
  "it-IT": {
    ...
    playbooks: "Procedure", learning: "Apprendimento", emmaMemory: "Memoria di Emma", emmaPermissions: "Autorizzazioni di Emma", voiceAliases: "Alias vocali", logout: "Esci",
