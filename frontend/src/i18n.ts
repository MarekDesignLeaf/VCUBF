...
export const MENU_KEYS = [
  ...
  "playbooks", "learning", "voiceAliases", "emmaMemory", "emmaPermissions", "logout", "overview", "customers", "workFinance", "growth", "management",
...
const ENGLISH: Record<MenuKey, string> = {
  ...
  playbooks: "Playbooks", learning: "Learning", emmaMemory: "{assistant} memory", emmaPermissions: "{assistant} permissions", voiceAliases: "Voice aliases", logout: "Log out",
...
const TRANSLATIONS: Record<AppLanguage, Partial<Record<MenuKey, string>>> = {
  ...
  "cs-CZ": {
    ...
    playbooks: "Postupy", learning: "Učení", emmaMemory: "Paměť {assistant}", emmaPermissions: "Oprávnění {assistant}", voiceAliases: "Hlasové aliasy", logout: "Odhlásit se",
  ...
  "pl-PL": {
    ...
    playbooks: "Procedury", learning: "Uczenie", emmaMemory: "Pamięć {assistant}", emmaPermissions: "Uprawnienia {assistant}", voiceAliases: "Aliasy głosowe", logout: "Wyloguj się",
  ...
  "fr-FR": {
    ...
    playbooks: "Procédures", learning: "Apprentissage", emmaMemory: "Mémoire de {assistant}", emmaPermissions: "Autorisations de {assistant}", voiceAliases: "Alias vocaux", logout: "Se déconnecter",
  ...
  "de-DE": {
    ...
    playbooks: "Abläufe", learning: "Lernen", emmaMemory: "{assistant}-Speicher", emmaPermissions: "{assistant}-Berechtigungen", voiceAliases: "Sprachaliase", logout: "Abmelden",
  ...
  "es-ES": {
    ...
    playbooks: "Procedimientos", learning: "Aprendizaje", emmaMemory: "Memoria de {assistant}", emmaPermissions: "Permisos de {assistant}", voiceAliases: "Alias de voz", logout: "Cerrar sesión",
  ...
  "it-IT": {
    ...
    playbooks: "Procedure", learning: "Apprendimento", emmaMemory: "Memoria di {assistant}", emmaPermissions: "Autorizzazioni di {assistant}", voiceAliases: "Alias vocali", logout: "Esci",
