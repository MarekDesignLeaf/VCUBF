...
const VOICE_COPY = {
  ...
  cs: {
    ...
    listener: "Naslouchání aktivačnímu slovu běží na pozadí; nejde o rozhovor.", oneActive: "Je aktivní jeden rozhovor v reálném čase.", noneActive: "Není aktivní žádný rozhovor v reálném čase.", sayEmma: "Řekněte zřetelně „Emma“ pro zahájení rozhovoru.", reactionsPaused: "Reakce mikrofonu jsou pozastavené.", noInput: "Emma nepřijímá zvuk z mikrofonu.", multiple: "Více než jeden rozhovor Emmy je označen jako aktivní. Před zahájením dalšího ukončete aktivní rozhovor.",
  ...
  fr: {
    ...
    listener: "L’écoute du mot d’activation fonctionne en arrière-plan ; ce n’est pas une conversation.", oneActive: "Une conversation en temps réel est active.", noneActive: "Aucune conversation en temps réel n’est active.", sayEmma: "Dites clairement « Emma » pour en commencer une.", reactionsPaused: "Les réactions du microphone sont en pause.", noInput: "Emma ne reçoit aucun son du microphone.", multiple: "Plusieurs conversations d’Emma sont marquées actives. Terminez la conversation active avant d’en commencer une autre.",
  ...
  it: {
    ...
    listener: "L’ascolto della parola di attivazione è attivo in background; non è una conversazione.", oneActive: "È attiva una conversazione in tempo reale.", noneActive: "Non è attiva alcuna conversazione in tempo reale.", sayEmma: "Dica chiaramente “Emma” per avviarne una.", reactionsPaused: "Le reazioni del microfono sono in pausa.", noInput: "Emma non riceve audio dal microfono.", multiple: "Più di una conversazione di Emma risulta attiva. Termini quella attiva prima di iniziarne un’altra.",
