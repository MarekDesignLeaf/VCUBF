...
const VOICE_COPY = {
  ...
  pl: {
    ...
    opened: "{assistant} otworzył", openedSuffix: "w Secretary.", changed: "{assistant} zmienił język menu Secretary na", heard: "{assistant} usłyszał po aktywacji", waiting: "Oczekiwanie na aktywację asystenta.", answered: "{assistant} odpowiedział", noResponse: "Brak odpowiedzi.",
  ...
  cs: {
    ...
    opened: "{assistant} otevřel", openedSuffix: "v Secretary.", changed: "{assistant} změnil jazyk menu Secretary na", heard: "{assistant} slyšel po aktivaci", waiting: "Čeká se na aktivaci asistenta.", answered: "{assistant} odpověděl", noResponse: "Zatím žádná odpověď.",
