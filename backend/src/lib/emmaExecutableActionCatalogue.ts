...
export const EMMA_EXECUTABLE_ACTION_PAGES: Record<EmmaExecutableActionName, string> = {
  ...
  set_quote_status: "quotes", update_quote: "quotes", export_quote_pdf: "quotes", create_invoice: "invoices", issue_invoice: "invoices", record_invoice_payment: "invoices", export_invoice_pdf: "invoices",
