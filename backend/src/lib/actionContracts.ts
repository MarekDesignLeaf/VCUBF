...
export const RECORD_INVOICE_PAYMENT_ACTION: ActionContract = { actionName:"record_invoice_payment",purpose:"Record a payment actually received against an invoice after explicit preview confirmation.",requiredPermission:"crm.manage",riskLevel:3,confirmationRequired:true,dataSources:["user_input","crm.invoices","crm.payments"],possibleErrors:["MISSING_PERMISSION","VALIDATION_FAILED","INVOICE_NOT_FOUND","INVOICE_VOID","PAYMENT_EXCEEDS_BALANCE","CONFIRMATION_REQUIRED"] };
...
export const UPDATE_JOB_RESOURCE_ACTION: ActionContract = { actionName:"update_job_resource",purpose:"Update readiness and entered cost evidence for a job resource.",requiredPermission:"crm.manage",riskLevel:2,confirmationRequired:false,dataSources:["user_input","crm.jobs","crm.job_resources"],possibleErrors:["MISSING_PERMISSION","VALIDATION_FAILED","RESOURCE_NOT_FOUND"] };
