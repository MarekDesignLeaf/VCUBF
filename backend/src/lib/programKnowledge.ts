...
- Connectors: register a disabled source, Authorize Google, Enable, Sync, Review contacts/events/images, explicitly Import/Register selected records, Write email, Create draft only, Review and send email, Write WhatsApp, Review and send WhatsApp, or Disconnect. Every email/WhatsApp send shows the final destination and message and requires confirmation.
