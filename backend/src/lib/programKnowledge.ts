...
- Connectors: **Register data source**, **Authorize Gmail/Contacts/Calendar/Drive/Google Photos**, **Enable**, **Initial sync** or **Sync changes**, **Select Drive images**, **Select Google Photos**, **Review contacts/events/images**, explicitly **Import/Register** selected records, **Write email**, **Create draft only**, **Review and send email**, **Write WhatsApp**, **Review and send WhatsApp**, or **Disconnect**. Guided setup registers missing sources, opens each available provider flow in sequence, resumes after OAuth, asks for the mandatory Enable confirmation and performs the first supported sync. Every email/WhatsApp send still shows the final destination and message and requires a separate confirmation.
