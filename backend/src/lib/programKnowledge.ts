...
- Connectors (/connectors): authorised Google Gmail, Contacts, Calendar and Drive integrations. Current Gmail/Contacts/Calendar use is read-only; Drive imports selected file references. Disconnect revokes and deletes encrypted credentials, not imported CRM facts.
