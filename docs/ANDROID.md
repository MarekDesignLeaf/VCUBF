...
3. Choose **Enable Alfonzo** once and grant microphone access.
4. Say `Alfonzo`, wait for her acknowledgement, then say the command. The screen shows exactly what she heard and what she answered.
5. Use **Pause Alfonzo** before handing the phone to somebody else. **Delete phone transcript** removes saved local text turns; it does not delete company records or persistent Alfonzo memories.
